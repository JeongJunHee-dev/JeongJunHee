...
//디비 접근. 입력
String sql = "insert into "+code+" (subject,comment,gongji,file1,file1_o,signdate,fid,thread) values ('"+subject+"','"+comment+"','"+gongji+"','"+file1_name+"','"+file1_rename+"','"+signdate+"',"+fid+",'A')";
