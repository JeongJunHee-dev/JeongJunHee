...
<table width=100% height=80 border=1>
	<tr>
		...
		<td width=40% align=center>
			<h1>
				<a href="/index.jsp">Air Dispatcher Decision Support & Program
				</a>
			</h1>
		</td>
          				 	...
          				 	<%if(session_id.equals("")) {//로그인 전%>
                				...
                				<input type="button" style="color: #fff; background: gray; font-size: 1.3em; border-radius: 0.5em; padding: 5px 20px;"value="로그인이 필요합니다.">
                							...
                							<%if(session_level.equals("10")) {//관리자%>
                																<a href="/admin/index.jsp"><input type="button" style="color: #fff; background: gray; font-size: 1.3em; border-radius: 0.5em; padding: 5px 20px;"value="관리자 모드"></a> 
                																<%} %>
